...
const url_CCdefaultTest = '&unit_system=si&start_time=now&fields=precipitation%2Ctemp%2Cwind_speed&apikey=';
...
const searchCoordinatesButtonPressed = async () => {
  ...
  RD0.innerHTML = Next5Data[0].precipitation[0].max.value;
